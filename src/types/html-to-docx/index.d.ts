declare module "html-to-docx"
{
     ...
     * @private
     */
    export default function HTMLtoDOCX(htmlString: string, headerHTMLString: string | null, documentOptions: DocumentOptions, footerHTMLString?: string): Promise<Buffer | Blob>;
}
